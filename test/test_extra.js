...
tap.test('extra.dtlsFingerprintFromSDP()', { timeout: 1000 }, (t) =>
{
	t.equal(extra.dtlsFingerprintFromSDP(sdpFingerprint1), rawFingerprint1);
	t.equal(extra.dtlsFingerprintFromSDP(sdpFingerprint2), rawFingerprint2);

	t.end();
});

tap.test('extra.dtlsFingerprintToSDP()', { timeout: 1000 }, (t) =>
{
	t.equal(extra.dtlsFingerprintToSDP(rawFingerprint1), sdpFingerprint1);
	t.equal(extra.dtlsFingerprintToSDP(rawFingerprint2), sdpFingerprint2);
