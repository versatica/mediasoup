	...
	{                                                                                                                     \
		...
		{                                                                                                                   \
			...
			{                                                                                                                 \
				...
				REQUIRE(                                                                                                        \
				  helpers::AreBuffersEqual(buffer, bufferLength, originalBuffer, bufferLength) == true);                        \
			}                                                                                                                 \
			if (!hasPadding && packet->GetPaddingLength() > 4 && packet->GetBufferLength() >= packet->GetPaddingLength() + 2) \
			{                                                                                                                 \
				REQUIRE_NOTHROW(packet->ShiftPayload(2, 2));                                                                    \
				REQUIRE_NOTHROW(packet->UnshiftPayload(2, 2));                                                                  \
				REQUIRE(                                                                                                        \
				  helpers::AreBuffersEqual(buffer, bufferLength, originalBuffer, bufferLength) == true);                        \
			}                                                                                                                 \
