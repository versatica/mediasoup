...
SCENARIO("RTP Monitor", "[rtp][monitor]")
{
	...
	{
	public:
		virtual void OnRtpMonitorScore(RtpMonitor* /*rtpMonitor*/, uint8_t /*score*/) override
		{
	...
	auto* rtpStream = new RtpStreamSend(&testRtpStreamListener, params, 200);
	...
	RtpMonitor rtpMonitor(&listener, rtpStream, 5);
