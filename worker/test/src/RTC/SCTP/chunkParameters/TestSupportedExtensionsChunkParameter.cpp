...
SCENARIO("Supported Extensions Chunk Parameter (32776)", "[sctp][serializable]")
{
	...
	SECTION("SupportedExtensionsChunkParameter::Parse() succeeds")
	{
		// clang-format off
		uint8_t buffer[] =
		{
		...
		auto* parameter = SupportedExtensionsChunkParameter::Parse(buffer, sizeof(buffer));
		...
		CHECK_PARAMETER(
		  ...
		  /*length*/ 8,
		  /*frozen*/ true,
		  /*parameterType*/ ChunkParameter::ChunkParameterType::SUPPORTED_EXTENSIONS,
		  /*unknownType*/ false,
	...
	SECTION("SupportedExtensionsChunkParameter::Factory() succeeds")
	{
		auto* parameter =
		  SupportedExtensionsChunkParameter::Factory(FactoryBuffer, sizeof(FactoryBuffer));
		...
		auto* parsedParameter =
		  SupportedExtensionsChunkParameter::Parse(parameter->GetBuffer(), parameter->GetLength());
