        ...
        std::vector<FeedbackPacketsMeta> feedbackPacketsMeta = {
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xaf, 0xcd, 0x00, 0x05, 0xfa, 0x17, 0xfa, 0x17,
                ...
                },
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xaf, 0xcd, 0x00, 0x06, 0xFA, 0x17, 0xFA, 0x17,
                                0x1C, 0xB7, 0xDA, 0xF3, 0x00, 0x0E, 0x00, 0x04,
                                0x00, 0x8A, 0xB0, 0x01, 0x20, 0x04, 0xE8, 0x08,
                                0x0C, 0xDC, 0x00, 0x02
                        }
                },
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x06, 0xFA, 0x17, 0xFA, 0x17,
                                0x1C, 0xB7, 0xDA, 0xF3, 0x00, 0x12, 0x00, 0x05,
                                0x00, 0x8A, 0xB1, 0x02, 0x20, 0x05, 0xF0, 0x18,
                                0x14, 0x24, 0x58, 0x01
                        }
                },

                {
                        ...
                        .deltas = std::vector<int16_t>{3, 5, 5, 0, 10, 0, 0, 4, 0, 1, 0, 2, 0, 2, 0, 2, 0, 2, 0, 1, 0, 4},
                        .buffer = std::vector<uint8_t> {
                                0x8F, 0xCD, 0x00, 0x0A, 0xFA, 0x17, 0xFA, 0x17,
                                0x06, 0xF5, 0x11, 0x4C, 0x0B, 0x6C, 0x00, 0x16,
                                0x09, 0x6D, 0x91, 0xEE, 0x20, 0x16, 0x0C, 0x14,
                                0x14, 0x00, 0x28, 0x00, 0x00, 0x10, 0x00, 0x04,
...

                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0x8F, 0xCD, 0x00, 0x05, 0xFA, 0x17, 0xFA, 0x17,
...

                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x06, 0xFA, 0x17, 0xFA, 0x17,
                                0x26, 0x9E, 0x8E, 0x50, 0x03, 0xA2, 0x00, 0x05,
                                0x0C, 0x7F, 0x33, 0x9F, 0x20, 0x05, 0xF8, 0x48,
                                0x14, 0x18, 0x4C, 0x01
                        }
                },
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x07, 0xFA, 0x17, 0xFA, 0x17,
                                0x33, 0xB0, 0x4A, 0xE8, 0x03, 0x99, 0x00, 0x07,
                                0x0C, 0x7F, 0x34, 0x9F, 0x20, 0x07, 0x38, 0x14,
                                0x18, 0x18, 0x1C, 0x38, 0x14, 0x00, 0x00, 0x03
                        }
                },
                {
                        .baseTimeRaw = 818996,
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x07, 0xFA, 0x17, 0xFA, 0x17,
                                0x26, 0x9E, 0x8E, 0x50, 0x03, 0xA7, 0x00, 0x07,
                                0x0C, 0x7F, 0x34, 0xA0, 0x20, 0x07, 0xE4, 0x00,
                                0x18, 0x14, 0x14, 0x60, 0x00, 0x00, 0x00, 0x03
                        }
                },
                {
                        .baseTimeRaw = 818996,
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x06, 0xFA, 0x17, 0xFA, 0x17,
                                0x33, 0xB0, 0x4A, 0xE8, 0x03, 0xA0, 0x00, 0x05,
                                0x0C, 0x7F, 0x34, 0xA0, 0x20, 0x05, 0xFC, 0x2C,
                                0x54, 0x18, 0x00, 0x01
                        }
                },
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0x8F, 0xCD, 0x00, 0x06, 0xFA, 0x17, 0xFA, 0x17,
                                0x26, 0x9E, 0x8E, 0x50, 0x03, 0xAE, 0x00, 0x06,
                                0x0C, 0x7F, 0x35, 0xA1, 0x20, 0x06, 0x9C, 0x34,
                                0x24, 0x14, 0x10, 0x34
                        }
                },
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x07, 0xFA, 0x17, 0xFA, 0x17,
                                0x00, 0x00, 0x04, 0xD2, 0x00, 0x0A, 0x00, 0x07,
                                0x0C, 0x89, 0x13, 0x00, 0x20, 0x07, 0x64, 0x08,
                                0x08, 0x0C, 0x04, 0x04, 0x0C, 0x00, 0x00, 0x03
                        }
                },
                {
                        .baseTimeRaw = 821524,
                ...
                },
                {
                        ...
                        .buffer = std::vector<uint8_t> {
                                0xAF, 0xCD, 0x00, 0x06, 0xFA, 0x17, 0xFA, 0x17,
                                0x08, 0xEB, 0x06, 0xD7, 0x00, 0x13, 0x00, 0x04,
                                0x0C, 0x89, 0x16, 0x02, 0x20, 0x04, 0x10, 0x00,
                                0x10, 0x00, 0x00, 0x02
                        }
                }
        };
