{
  'target_defaults': {
    ...
    [
      ...
      'src/RTC/SendTransportController/bitrate_controller/loss_based_bandwidth_estimation.cc',
      'src/RTC/SendTransportController/bitrate_controller/send_side_bandwidth_estimation.cc',
      'src/RTC/SendTransportController/bitrate_settings.cc',
      'src/RTC/SendTransportController/congestion_controller/acknowledged_bitrate_estimator.cc',
      'src/RTC/SendTransportController/congestion_controller/alr_detector.cc',
      'src/RTC/SendTransportController/congestion_controller/bitrate_estimator.cc',
      'src/RTC/SendTransportController/congestion_controller/congestion_window_pushback_controller.cc',
      'src/RTC/SendTransportController/congestion_controller/delay_based_bwe.cc',
      'src/RTC/SendTransportController/congestion_controller/goog_cc_network_control.cc',
      'src/RTC/SendTransportController/congestion_controller/link_capacity_estimator.cc',
      'src/RTC/SendTransportController/congestion_controller/median_slope_estimator.cc',
      'src/RTC/SendTransportController/congestion_controller/probe_bitrate_estimator.cc',
      'src/RTC/SendTransportController/congestion_controller/probe_controller.cc',
      'src/RTC/SendTransportController/congestion_controller/rtp/control_handler.cc',
      'src/RTC/SendTransportController/congestion_controller/rtp/send_time_history.cc',
      'src/RTC/SendTransportController/congestion_controller/rtp/transport_feedback_adapter.cc',
      'src/RTC/SendTransportController/congestion_controller/trendline_estimator.cc',
      ...
      'src/RTC/SendTransportController/goog_cc_factory.cc',
      'src/RTC/SendTransportController/network_types.cc',
      'src/RTC/SendTransportController/pacing/bitrate_prober.cc',
      'src/RTC/SendTransportController/pacing/interval_budget.cc',
      'src/RTC/SendTransportController/pacing/paced_sender.cc',
      'src/RTC/SendTransportController/pacing/packet_router.cc',
      'src/RTC/SendTransportController/rate_control_settings.cc',
      'src/RTC/SendTransportController/remote_bitrate_estimator/aimd_rate_control.cc',
      'src/RTC/SendTransportController/remote_bitrate_estimator/bwe_defines.cc',
      'src/RTC/SendTransportController/remote_bitrate_estimator/inter_arrival.cc',
      'src/RTC/SendTransportController/remote_bitrate_estimator/overuse_detector.cc',
      'src/RTC/SendTransportController/rtcp_helpers.cc',
      'src/RTC/SendTransportController/rtp_rtcp_defines.cc',
      'src/RTC/SendTransportController/rtp_transport_controller_send.cc',
      'src/RTC/SendTransportController/sent_packet.cc',
      ...
      'include/RTC/SendTransportController/rtp_helpers.h',
      ...
      'include/RTC/SendTransportController/sent_packet.h',
