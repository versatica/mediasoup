...
// Chunk::ChunkType2String(GetType()).c_str(), HasUnknownType() ? "yes" : "no"); 			MS_DUMP("
// flags: " MS_UINT8_4BITS_TO_BINARY_PATTERN, MS_UINT8_4BITS_TO_BINARY(GetFlags())); 			MS_DUMP(
// "  length field: %" PRIu16 " (value length: %" PRIu16 ")", 			  GetLengthField(),
// GetValueLength()); 			MS_DUMP("</DataChunk>");
// 		}
