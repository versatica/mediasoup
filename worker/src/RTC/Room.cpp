...
namespace RTC
{
	...
	void Room::onPeerCapabilities(RTC::Peer* peer, RTC::RtpCapabilities* capabilities)
	{
		...
		capabilities->RemoveUnsupportedFecMechanisms(this->capabilities.fecMechanisms);
