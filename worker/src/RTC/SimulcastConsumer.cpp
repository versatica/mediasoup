...
namespace RTC
{
	  ...
	  : RTC::Consumer::Consumer(id, listener, data, RTC::RtpParameters::Type::SIMULCAST)
	{
		...
		if (!RTC::Codecs::Common::IsValidTypeForCodec(this->type, mediaCodec->mimeType))
		{
			MS_THROW_TYPE_ERROR(
		...
		this->encodingContext.reset(RTC::Codecs::Common::GetEncodingContext(mediaCodec->mimeType, params));
