...
*/
	...
	void SimulcastConsumer::CreateRtpStream()
	{
		...
		this->rtpStreamBinLogRecord = new Lively::CallStatsRecordCtx(1, this->rtpStream->GetSsrc(), this->kind == Media::Kind::VIDEO ? 'v': 'a', lively.callId, this->id, this->producerId);			
