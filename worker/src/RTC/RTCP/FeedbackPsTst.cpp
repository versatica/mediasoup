...
namespace RTC { namespace RTCP
{
	...
	template<>
	const FeedbackPs::MessageType FeedbackPsTstItem<Tstr>::MessageType = FeedbackPs::MessageType::TSTR;

	/* Specialization for Tstn class. */

	template<>
	const FeedbackPs::MessageType FeedbackPsTstItem<Tstn>::MessageType = FeedbackPs::MessageType::TSTN;
