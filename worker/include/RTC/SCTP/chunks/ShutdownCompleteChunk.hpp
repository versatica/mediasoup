...
namespace RTC
{
	...
	{
		/**
		 * Shutdown Complete (SHUTDOWN COMPLETE) (8).
		 *
		 * @see RFC 9260.
		 *
		 *  0                   1                   2                   3
		...
		public:
			static constexpr Chunk::ChunkType type = Chunk::ChunkType::SHUTDOWN_COMPLETE;
		...
		private:
			 ...
			 */
			ShutdownCompleteChunk(const uint8_t* buffer, size_t bufferLength);
