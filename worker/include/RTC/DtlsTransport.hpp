...
namespace RTC
{
	...
	public:
		...
		public:
			...
			// NOTE: The caller MUST NOT call any method during this callback.
			virtual void onDtlsConnected(const RTC::DtlsTransport* dtlsTransport, RTC::SrtpSession::Profile srtpProfile, uint8_t* srtpLocalKey, size_t srtpLocalKeyLen, uint8_t* srtpRemoteKey, size_t srtpRemoteKeyLen, std::string& remoteCert) = 0;
			...
			// NOTE: The caller MUST NOT call Destroy() during this callback.
			virtual void onOutgoingDtlsData(const RTC::DtlsTransport* dtlsTransport, const uint8_t* data, size_t len) = 0;
			// DTLS application data received.
			// NOTE: The caller MUST NOT call Destroy() during this callback.
			virtual void onDtlsApplicationData(const RTC::DtlsTransport* dtlsTransport, const uint8_t* data, size_t len) = 0;
		};
