#ifndef MS_RTC_OLD_CONSUMER_HPP
...
namespace RTC
{
	...
	class OldConsumer : public Channel::ChannelSocket::RequestHandler
	{
	public:
		class Listener
		{
		...
		public:
			virtual void OnConsumerSendRtpPacket(RTC::OldConsumer* consumer, RTC::RTP::Packet* packet) = 0;
			virtual void OnConsumerRetransmitRtpPacket(
			  RTC::OldConsumer* consumer, RTC::RTP::Packet* packet)                                   = 0;
			virtual void OnConsumerKeyFrameRequested(RTC::OldConsumer* consumer, uint32_t mappedSsrc) = 0;
			virtual void OnConsumerNeedBitrateChange(RTC::OldConsumer* consumer)                      = 0;
			virtual void OnConsumerNeedZeroBitrate(RTC::OldConsumer* consumer)                        = 0;
			virtual void OnConsumerProducerClosed(RTC::OldConsumer* consumer)                         = 0;
		};
