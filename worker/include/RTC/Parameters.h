#ifndef MS_RTC_PARAMETERS_H
#define MS_RTC_PARAMETERS_H
...
namespace RTC
{
	...
	inline
	bool Parameters::HasBoolean(std::string& key)
	{
	...
	inline
	bool Parameters::HasInteger(std::string& key)
	{
		if (this->mapKeyValues.find(key) == this->mapKeyValues.end())
			return false;
	...
	inline
	bool Parameters::HasDouble(std::string& key)
	{
		if (this->mapKeyValues.find(key) == this->mapKeyValues.end())
			return false;
	...
	inline
	bool Parameters::HasString(std::string& key)
	{
		if (this->mapKeyValues.find(key) == this->mapKeyValues.end())
			return false;
	...
	inline
	bool Parameters::HasArrayOfIntegers(std::string& key)
	{
		if (this->mapKeyValues.find(key) == this->mapKeyValues.end())
			return false;
	...
	inline
	bool Parameters::IncludesInteger(std::string& key, int32_t integer)
	{
		if (this->mapKeyValues.find(key) == this->mapKeyValues.end())
			return false;
	...
	inline
	void Parameters::SetBoolean(std::string& key, bool booleanValue)
	{
		this->mapKeyValues[key] = Value(booleanValue);
	}

	inline
	void Parameters::SetInteger(std::string& key, int32_t integerValue)
	{
		this->mapKeyValues[key] = Value(integerValue);
	}

	inline
	void Parameters::SetDouble(std::string& key, double doubleValue)
	{
		this->mapKeyValues[key] = Value(doubleValue);
	}

	inline
	void Parameters::SetString(std::string& key, std::string& stringValue)
	{
		this->mapKeyValues[key] = Value(stringValue);
	}

	inline
	void Parameters::SetArrayOfIntegers(std::string& key, std::vector<int32_t>& arrayOfIntegers)
	{
