...
exports.RtpParameters = void 0;
const flatbuffers = require("flatbuffers");
const rtcp_parameters_1 = require("../../f-b-s/transport/rtcp-parameters");
const rtp_codec_parameters_1 = require("../../f-b-s/transport/rtp-codec-parameters");
const rtp_encoding_parameters_1 = require("../../f-b-s/transport/rtp-encoding-parameters");
const rtp_header_extension_parameters_1 = require("../../f-b-s/transport/rtp-header-extension-parameters");
class RtpParameters {
    bb = null;
    bb_pos = 0;
    __init(i, bb) {
    ...
    rtcp(index, obj) {
        ...
        return offset ? (obj || new rtcp_parameters_1.RtcpParameters()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
    }
    rtcpLength() {
        const offset = this.bb.__offset(this.bb_pos, 12);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    ...
    static createRtcpVector(builder, data) {
        builder.startVector(4, data.length, 4);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addOffset(data[i]);
        }
    ...
    static startRtcpVector(builder, numElems) {
        builder.startVector(4, numElems, 4);
    }
    ...
    static createRtpParameters(builder, midOffset, codecsOffset, headerExtensionsOffset, encodingsOffset, rtcpOffset) {
        ...
        RtpParameters.addHeaderExtensions(builder, headerExtensionsOffset);
