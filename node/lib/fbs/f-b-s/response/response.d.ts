...
import { DumpT } from '../../f-b-s/worker/dump';
import { ResourceUsageT } from '../../f-b-s/worker/resource-usage';
...
export declare class ResponseT {
    ...
    accepted: boolean;
    bodyType: Body;
    body: ConsumeResponseT | DumpT | ResourceUsageT | null;
    constructor(id?: number, accepted?: boolean, bodyType?: Body, body?: ConsumeResponseT | DumpT | ResourceUsageT | null);
