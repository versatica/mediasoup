...
exports.RouterDumpResponseT = exports.RouterDumpResponse = void 0;
...
class RouterDumpResponse {
    ...
    static getRootAsRouterDumpResponse(bb, obj) {
        return (obj || new RouterDumpResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsRouterDumpResponse(bb, obj) {
    ...
    static startRouterDumpResponse(builder) {
    ...
    static endRouterDumpResponse(builder) {
        const offset = builder.endObject();
        builder.requiredField(offset, 4); // id
        return offset;
    }
    static createRouterDumpResponse(builder, idOffset, transportIdsOffset, rtpObserverIdsOffset, mapProducerIdConsumerIdsOffset, mapConsumerIdProducerIdOffset, mapProducerIdObserverIdsOffset, mapDataProducerIdDataConsumerIdsOffset, mapDataConsumerIdDataProducerIdOffset) {
...
exports.RouterDumpResponse = RouterDumpResponse;
class RouterDumpResponseT {
    id;
    transportIds;
    rtpObserverIds;
    ...
    pack(builder) {
        ...
        return RouterDumpResponse.createRouterDumpResponse(builder, id, transportIds, rtpObserverIds, mapProducerIdConsumerIds, mapConsumerIdProducerId, mapProducerIdObserverIds, mapDataProducerIdDataConsumerIds, mapDataConsumerIdDataProducerId);
    }
}
exports.RouterDumpResponseT = RouterDumpResponseT;
