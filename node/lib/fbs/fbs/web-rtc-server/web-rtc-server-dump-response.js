...
exports.WebRtcServerDumpResponseT = exports.WebRtcServerDumpResponse = void 0;
...
class WebRtcServerDumpResponse {
    bb = null;
    bb_pos = 0;
    __init(i, bb) {
        this.bb_pos = i;
    ...
    static getRootAsWebRtcServerDumpResponse(bb, obj) {
        return (obj || new WebRtcServerDumpResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsWebRtcServerDumpResponse(bb, obj) {
    ...
    static startWebRtcServerDumpResponse(builder) {
    ...
    static endWebRtcServerDumpResponse(builder) {
        const offset = builder.endObject();
        builder.requiredField(offset, 4); // id
        return offset;
    }
    static createWebRtcServerDumpResponse(builder, idOffset, udpSocketsOffset, tcpServersOffset, webRtcTransportIdsOffset, localIceUsernameFragmentsOffset, tupleHashesOffset) {
...
exports.WebRtcServerDumpResponse = WebRtcServerDumpResponse;
class WebRtcServerDumpResponseT {
    id;
    udpSockets;
    tcpServers;
    webRtcTransportIds;
    ...
    pack(builder) {
        ...
        return WebRtcServerDumpResponse.createWebRtcServerDumpResponse(builder, id, udpSockets, tcpServers, webRtcTransportIds, localIceUsernameFragments, tupleHashes);
    }
}
exports.WebRtcServerDumpResponseT = WebRtcServerDumpResponseT;
