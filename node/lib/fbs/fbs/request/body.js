...
(function (Body) {
    ...
    Body[Body["FBS_Router_CreateWebRtcTransportRequest"] = 1] = "FBS_Router_CreateWebRtcTransportRequest";
    Body[Body["FBS_Transport_ConsumeRequest"] = 2] = "FBS_Transport_ConsumeRequest";
    Body[Body["FBS_Worker_UpdateableSettings"] = 3] = "FBS_Worker_UpdateableSettings";
    Body[Body["FBS_Worker_CreateWebRtcServerRequest"] = 4] = "FBS_Worker_CreateWebRtcServerRequest";
    Body[Body["FBS_Worker_CloseWebRtcServerRequest"] = 5] = "FBS_Worker_CloseWebRtcServerRequest";
    Body[Body["FBS_Worker_CreateRouterRequest"] = 6] = "FBS_Worker_CreateRouterRequest";
    Body[Body["FBS_Worker_CloseRouterRequest"] = 7] = "FBS_Worker_CloseRouterRequest";
