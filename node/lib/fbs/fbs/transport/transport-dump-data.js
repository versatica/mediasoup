...
const plain_transport_dump_1 = require("../../fbs/plain-transport/plain-transport-dump");
...
(function (TransportDumpData) {
    ...
    TransportDumpData[TransportDumpData["FBS_PlainTransport_PlainTransportDump"] = 4] = "FBS_PlainTransport_PlainTransportDump";
...
function unionToTransportDumpData(type, accessor) {
    switch (TransportDumpData[type]) {
        ...
        case 'FBS_PlainTransport_PlainTransportDump': return accessor(new plain_transport_dump_1.PlainTransportDump());
...
function unionListToTransportDumpData(type, accessor, index) {
    switch (TransportDumpData[type]) {
        ...
        case 'FBS_PlainTransport_PlainTransportDump': return accessor(index, new plain_transport_dump_1.PlainTransportDump());
