...
export declare class ResponseT {
    ...
    accepted: boolean;
    bodyType: Body;
    body: ConsumeResponseT | DumpResponseT | FBS_DataConsumer_DumpResponseT | FBS_DataProducer_DumpResponseT | FBS_Router_DumpResponseT | FBS_Transport_DumpResponseT | FBS_WebRtcServer_DumpResponseT | GetBufferedAmountResponseT | ProduceResponseT | ResourceUsageResponseT | SetPreferredLayersResponseT | SetPriorityResponseT | null;
    constructor(id?: number, accepted?: boolean, bodyType?: Body, body?: ConsumeResponseT | DumpResponseT | FBS_DataConsumer_DumpResponseT | FBS_DataProducer_DumpResponseT | FBS_Router_DumpResponseT | FBS_Transport_DumpResponseT | FBS_WebRtcServer_DumpResponseT | GetBufferedAmountResponseT | ProduceResponseT | ResourceUsageResponseT | SetPreferredLayersResponseT | SetPriorityResponseT | null);
