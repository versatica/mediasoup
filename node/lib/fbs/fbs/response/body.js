...
const dump_response_4 = require("../../fbs/producer/dump-response");
const dump_response_5 = require("../../fbs/router/dump-response");
const consume_response_1 = require("../../fbs/transport/consume-response");
const dump_response_6 = require("../../fbs/transport/dump-response");
const produce_response_1 = require("../../fbs/transport/produce-response");
const dump_response_7 = require("../../fbs/web-rtc-server/dump-response");
const dump_response_8 = require("../../fbs/worker/dump-response");
...
(function (Body) {
    ...
    Body[Body["FBS_Producer_DumpResponse"] = 8] = "FBS_Producer_DumpResponse";
    Body[Body["FBS_Consumer_DumpResponse"] = 9] = "FBS_Consumer_DumpResponse";
    Body[Body["FBS_Consumer_SetPreferredLayersResponse"] = 10] = "FBS_Consumer_SetPreferredLayersResponse";
    Body[Body["FBS_Consumer_SetPriorityResponse"] = 11] = "FBS_Consumer_SetPriorityResponse";
    Body[Body["FBS_DataProducer_DumpResponse"] = 12] = "FBS_DataProducer_DumpResponse";
    Body[Body["FBS_DataConsumer_GetBufferedAmountResponse"] = 13] = "FBS_DataConsumer_GetBufferedAmountResponse";
    Body[Body["FBS_DataConsumer_DumpResponse"] = 14] = "FBS_DataConsumer_DumpResponse";
})(Body = exports.Body || (exports.Body = {}));
function unionToBody(type, accessor) {
    switch (Body[type]) {
        case 'NONE': return null;
        case 'FBS_Worker_DumpResponse': return accessor(new dump_response_8.DumpResponse());
        case 'FBS_Worker_ResourceUsageResponse': return accessor(new resource_usage_response_1.ResourceUsageResponse());
        case 'FBS_WebRtcServer_DumpResponse': return accessor(new dump_response_7.DumpResponse());
        case 'FBS_Router_DumpResponse': return accessor(new dump_response_5.DumpResponse());
        case 'FBS_Transport_DumpResponse': return accessor(new dump_response_6.DumpResponse());
        ...
        case 'FBS_Producer_DumpResponse': return accessor(new dump_response_4.DumpResponse());
        case 'FBS_Consumer_DumpResponse': return accessor(new dump_response_1.DumpResponse());
        ...
        case 'FBS_DataProducer_DumpResponse': return accessor(new dump_response_3.DumpResponse());
        ...
        case 'FBS_DataConsumer_DumpResponse': return accessor(new dump_response_2.DumpResponse());
        default: return null;
    }
}
...
function unionListToBody(type, accessor, index) {
    switch (Body[type]) {
        case 'NONE': return null;
        case 'FBS_Worker_DumpResponse': return accessor(index, new dump_response_8.DumpResponse());
        case 'FBS_Worker_ResourceUsageResponse': return accessor(index, new resource_usage_response_1.ResourceUsageResponse());
        case 'FBS_WebRtcServer_DumpResponse': return accessor(index, new dump_response_7.DumpResponse());
        case 'FBS_Router_DumpResponse': return accessor(index, new dump_response_5.DumpResponse());
        case 'FBS_Transport_DumpResponse': return accessor(index, new dump_response_6.DumpResponse());
        ...
        case 'FBS_Producer_DumpResponse': return accessor(index, new dump_response_4.DumpResponse());
        case 'FBS_Consumer_DumpResponse': return accessor(index, new dump_response_1.DumpResponse());
        ...
        case 'FBS_DataProducer_DumpResponse': return accessor(index, new dump_response_3.DumpResponse());
        ...
        case 'FBS_DataConsumer_DumpResponse': return accessor(index, new dump_response_2.DumpResponse());
        default: return null;
    }
}
