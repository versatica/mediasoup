...
class DumpResponse {
    ...
    unpack() {
        return new DumpResponseT(this.id(), this.dataProducerId(), this.type(), (this.sctpStreamParameters() !== null ? this.sctpStreamParameters().unpack() : null), this.label(), this.protocol());
    }
    unpackTo(_o) {
        _o.id = this.id();
...
class DumpResponseT {
    ...
    label;
    protocol;
    constructor(id = null, dataProducerId = null, type = null, sctpStreamParameters = null, label = null, protocol = null) {
        this.id = id;
