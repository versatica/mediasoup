...
exports.ResourceUsageT = exports.ResourceUsage = void 0;
...
class ResourceUsage {
    ...
    static getRootAsResourceUsage(bb, obj) {
        return (obj || new ResourceUsage()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
    }
    static getSizePrefixedRootAsResourceUsage(bb, obj) {
    ...
    static startResourceUsage(builder) {
    ...
    static endResourceUsage(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createResourceUsage(builder, ruUtime, ruStime, ruMaxrss, ruIxrss, ruIdrss, ruIsrss, ruMinflt, ruMajflt, ruNswap, ruInblock, ruOublock, ruMsgsnd, ruMsgrcv, ruNsignals, ruNvcsw, ruNivcsw) {
    ...
    unpack() {
        return new ResourceUsageT(this.ruUtime(), this.ruStime(), this.ruMaxrss(), this.ruIxrss(), this.ruIdrss(), this.ruIsrss(), this.ruMinflt(), this.ruMajflt(), this.ruNswap(), this.ruInblock(), this.ruOublock(), this.ruMsgsnd(), this.ruMsgrcv(), this.ruNsignals(), this.ruNvcsw(), this.ruNivcsw());
    }
    unpackTo(_o) {
...
class ResourceUsageT {
    ...
    pack(builder) {
        return ResourceUsage.createResourceUsage(builder, this.ruUtime, this.ruStime, this.ruMaxrss, this.ruIxrss, this.ruIdrss, this.ruIsrss, this.ruMinflt, this.ruMajflt, this.ruNswap, this.ruInblock, this.ruOublock, this.ruMsgsnd, this.ruMsgrcv, this.ruNsignals, this.ruNvcsw, this.ruNivcsw);
    }
}
exports.ResourceUsageT = ResourceUsageT;
