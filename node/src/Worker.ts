...
export type WorkerSettings<WorkerAppData> =
{
	/**
...
export type WorkerUpdateableSettings<T> = Pick<WorkerSettings<T>, 'logLevel' | 'logTags'>;
	...
	extends EnhancedEventEmitter<WorkerEvents>
{
	...
	// Custom app data.
	readonly #appData: WorkerAppData;
	 ...
	 * Invalid setter.
	 */
	set appData(appData: WorkerAppData) // eslint-disable-line no-unused-vars
	{
