...
export type ConsumerOptions =
{
	...
	/**
	 * Whether this Consumer should ignore NACK packets (only valid for Opus codec).
	 * If set, retransmissions will not be sent when receiving a NACK packet. Default is true.
	 */
	ignoreNack?: Boolean;
