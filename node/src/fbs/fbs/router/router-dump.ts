...
static startRouterDump(builder:flatbuffers.Builder) {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RouterDump.createRouterDump(builder,
    id,
    transportIds,
    rtpObserverIds,
