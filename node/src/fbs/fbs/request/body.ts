...
): CloseRouterRequest|CloseWebRtcServerRequest|ConsumeRequest|CreateDirectTransportRequest|CreatePipeTransportRequest|CreatePlainTransportRequest|CreateRouterRequest|CreateWebRtcServerRequest|CreateWebRtcTransportRequest|UpdateSettingsRequest|null {
  switch(Body[type]) {
