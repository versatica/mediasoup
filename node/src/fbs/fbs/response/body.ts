...
export function unionToBody(
  type: Body,
  accessor: (obj:ConsumeResponse|ResourceUsage|TransportDump|WebRtcServerDump|WorkerDump) => ConsumeResponse|ResourceUsage|TransportDump|WebRtcServerDump|WorkerDump|null
): ConsumeResponse|ResourceUsage|TransportDump|WebRtcServerDump|WorkerDump|null {
  switch(Body[type]) {
...
export function unionListToBody(
  type: Body, 
  accessor: (index: number, obj:ConsumeResponse|ResourceUsage|TransportDump|WebRtcServerDump|WorkerDump) => ConsumeResponse|ResourceUsage|TransportDump|WebRtcServerDump|WorkerDump|null, 
  index: number
): ConsumeResponse|ResourceUsage|TransportDump|WebRtcServerDump|WorkerDump|null {
  switch(Body[type]) {
    case 'NONE': return null; 
