...
static startResourceUsageResponse(builder:flatbuffers.Builder) {
...
unpack(): ResourceUsageResponseT {
  return new ResourceUsageResponseT(
    this.ruUtime(),
    this.ruStime(),
    this.ruMaxrss(),
    this.ruIxrss(),
...
export class ResourceUsageResponseT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return ResourceUsageResponse.createResourceUsageResponse(builder,
    this.ruUtime,
    this.ruStime,
    this.ruMaxrss,
    this.ruIxrss,
