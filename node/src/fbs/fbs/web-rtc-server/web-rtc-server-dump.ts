...
static startWebRtcServerDump(builder:flatbuffers.Builder) {
...
export class WebRtcServerDumpT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return WebRtcServerDump.createWebRtcServerDump(builder,
    id,
    udpSockets,
    tcpServers,
    webRtcTransportIds,
