...
rtcp(index: number, obj?:RtcpParameters):RtcpParameters|null {
  ...
  return offset ? (obj || new RtcpParameters()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
static startRtcpVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}
