...
class Transport extends EventEmitter
{
	...
	close(error, dontSendChannel)
	{
		...
		// Remove notification subscriptions (do it in the next iteration to
		// ensure the user receives closure events)
		setImmediate(() => this._channel.removeAllListeners(this._internal.transportId));
