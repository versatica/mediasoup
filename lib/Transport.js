...
class Transport extends EnhancedEventEmitter
{
   ...
   *
	...
	)
	{
		...
		// TODO: Must clone them and set an id (based on used ones and max channales etc).
		const sctpStreamParameters = dataProducer.sctpStreamParameters;
		...
		dataConsumer.on('@dataproducerclose', () => this._dataConsumers.delete(dataConsumer.id));
