...
class Transport extends EnhancedEventEmitter_1.EnhancedEventEmitter {
     ...
     */
    async produceSctpData({ id = undefined, sctpStreamParameters, label = '', protocol = '', appData = {} }) {
     ...
     */
    async produceData(options) {
        logger.warn('produceData() is DEPRECATED, use produceSctpData()');
