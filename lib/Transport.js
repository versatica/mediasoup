...
class Transport extends EnhancedEventEmitter
{
   ...
   *
	...
	async produce({ kind, rtpParameters, appData = {} } = {})
	{
		...
		// This may throw.
		const { translatedRtpParameters, mapping } =
			ortc.translateProducerRtpParameters(rtpParameters, this._routerRtpCapabilities);
		...
		const data = { kind, rtpParameters, translatedRtpParameters };
