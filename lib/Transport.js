...
class Transport extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    async produce({ id = undefined, kind, rtpParameters, paused = false, keyFrameRequestDelay, appData = {} }) {
        ...
        const internal = Object.assign(Object.assign({}, this._internal), { producerId: id || uuid_1.v4() });
    ...
    async consume({ producerId, rtpCapabilities, paused = false, preferredLayers, appData = {} }) {
        ...
        const internal = Object.assign(Object.assign({}, this._internal), { consumerId: uuid_1.v4(), producerId });
        const reqData = {
            kind: producer.kind,
            rtpParameters,
            type: producer.type,
    ...
    async produceData({ id = undefined, sctpStreamParameters, label = '', protocol = '', appData = {} } = {}) {
        ...
        const internal = Object.assign(Object.assign({}, this._internal), { dataProducerId: id || uuid_1.v4() });
        const reqData = {
            type,
    ...
    async consumeData({ dataProducerId, ordered, maxPacketLifeTime, maxRetransmits, appData = {} }) {
        ...
        const internal = Object.assign(Object.assign({}, this._internal), { dataConsumerId: uuid_1.v4(), dataProducerId });
        const reqData = {
            type,
            sctpStreamParameters,
            label,
