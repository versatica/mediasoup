...
class Transport extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    async produce({ id = undefined, kind, rtpParameters, paused = false, keyFrameRequestDelay, appData = {} }) {
        ...
        const internal = { ...this._internal, producerId: id || v4_1.default() };
    ...
    async consume({ producerId, rtpCapabilities, paused = false, preferredLayers, appData = {} }) {
        ...
        const internal = { ...this._internal, consumerId: v4_1.default(), producerId };
        const reqData = {
            kind: producer.kind,
            rtpParameters,
            type: producer.type,
    ...
    async produceData({ id = undefined, sctpStreamParameters, label = '', protocol = '', appData = {} }) {
        ...
        const internal = { ...this._internal, dataProducerId: id || v4_1.default() };
    ...
    async consumeData({ dataProducerId, appData = {} }) {
        ...
        const internal = { ...this._internal, dataConsumerId: v4_1.default(), dataProducerId };
        const reqData = { sctpStreamParameters, label, protocol };
