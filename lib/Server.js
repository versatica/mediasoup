...
class Server extends EventEmitter
{
	 ...
	 * @param  {[String]} options.logLevel  'debug'/'warn'/'error'
	 * @param  {[String|boolean]} options.rtcListenIPv4
	 * @param  {[String|boolean]} options.rtcListenIPv6
	 * @param  {[Number]} options.rtcMinPort
	 * @param  {[Number]} options.rtcMaxPort
	 * @param  {[String]} options.dtlsCertificateFile  DTLS pubic certificate file
	 * @param  {[String]} options.dtlsPrivateKeyFile   DTLS private key file
	 */
	constructor(options)
	{
		...
		for (let i = 1; i <= numWorkers; i++)
		{
			...
			// (do it in a separate method to avoid creating a callback
	 ...
	 * @param  {[Object]} options
	 * @param  {[Boolean]} options.forceUniquePayloadTypes
	 * @return {Room}
	 */
	Room(options)
	{
