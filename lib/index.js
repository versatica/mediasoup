...
)
{
	...
	return new Promise((resolve, reject) =>
	{
		...
		{
			// Emit observer event.
			observer.safeEmit('observer:newworker', worker);
...
/**
 * Get the list of supported media codecs.
 *
 * @return {Array<RTCRtpCodecCapabilities>} - Cloned list of media codecs.
 */
exports.getSupportedMediaCodecs = function()
{
	return utils.clone(supportedRtpCapabilities.codecs);
};
 ...
 * @type {EventEmitter}
 *
 * @emits {worker: Worker} observer:newworker
 */
