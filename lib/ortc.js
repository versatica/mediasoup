...
function generateRouterRtpCapabilities(mediaCodecs = []) {
    ...
    const supportedCodecs = supportedRtpCapabilities_1.supportedRtpCapabilities.codecs;
    const caps = {
        codecs: [],
        headerExtensions: supportedRtpCapabilities_1.supportedRtpCapabilities.headerExtensions,
        fecMechanisms: supportedRtpCapabilities_1.supportedRtpCapabilities.fecMechanisms
    };
