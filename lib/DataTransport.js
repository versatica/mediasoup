...
class DataTransport extends Transport_1.Transport {
    ...
    async setMaxIncomingBitrate(bitrate) {
        throw new errors_1.NotImplementedError('setMaxIncomingBitrate() not implemented in DataTransport');
    }
    /**
     * @override
     */
    ...
    async produce(options) {
        throw new errors_1.NotImplementedError('produce() not implemented in DataTransport');
    }
    /**
     * @override
     */
    ...
    async consumer(options) {
        throw new errors_1.NotImplementedError('consumer() not implemented in DataTransport');
    }
