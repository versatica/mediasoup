...
class RTCPeerConnectionCommon extends EventEmitter
{
	...
	iceRestart(desc)
	{
		...
		// Fix the SDP answer according to the received offer.
		sdpUtils.fixAnswerForIceRestart(remoteDescription.parsed, localDescription.parsed);
		localDescription.rewriteSdp();
