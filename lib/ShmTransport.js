            ...
            this._channel.on(this._internal.transportId, (event, data) => __awaiter(this, void 0, void 0, function* () {
                switch (event) {
                    case 'writestreammetadata':
                        {
                            const reqdata = data;
                            yield this._channel.request('transport.writestreammetadata', this._internal, reqdata); //TODO: so... let's write stream metadata via transport.writemetadata command
                            break;
                        }
                    default:
                        {
