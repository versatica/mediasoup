...
class Room extends EventEmitter
{
	 ...
	 * @return {Peer}
	 */
	Peer(peerName, rtpCapabilities)
	{
		logger.debug('Peer() [peerName:"%s", rtpCapabilities:%o]',
			peerName, rtpCapabilities);
		...
		if (!rtpCapabilities || typeof rtpCapabilities !== 'object')
			throw new TypeError('rtpCapabilities must be an object');
		...
		this._channel.request('room.createPeer', internal, rtpCapabilities)
			.then(() =>
			{
