...
class Channel extends EventEmitter
{
	...
	_processMessage(json)
	{
		...
		else if (json.targetId && json.eventName)
		{
			let targetId = json.targetId;
			let eventName = json.eventName;

			logger.debug('received Notification [targetId:%s, eventName:%s]', targetId, eventName);

			// Emit it
			this.emit(targetId, eventName, json.eventData);
		}
