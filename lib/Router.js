...
class Router extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    async createWebRtcTransport({ listenIps, enableUdp = true, enableTcp = false, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, appData = {} }) {
        ...
        listenIps = utils_1.flatten(listenIps
            .map((listenIp) => {
            ...
            switch (listenIp.ip) {
                case '0.0.0.0':
                    return utils_1.getIpv4IPs().map((ip) => {
                        return Object.assign(Object.assign({}, listenIp), { ip });
                    });
                case '::':
                    return utils_1.getAllIPs().map((ip) => {
                        return Object.assign(Object.assign({}, listenIp), { ip });
                    });
                default:
                    return listenIp;
            ...
            .slice(0, 8);
        const internal = Object.assign(Object.assign({}, this._internal), { transportId: uuid_1.v4() });
        const reqData = {
            listenIps,
            enableUdp,
            enableTcp,
    ...
    async createAudioLevelObserver({ maxEntries = 1, threshold = -80, interval = 1000, appData = {} } = {}) {
        ...
        if (appData && typeof appData !== 'object')
            throw new TypeError('if given, appData must be an object');
        const internal = Object.assign(Object.assign({}, this._internal), { rtpObserverId: uuid_1.v4() });
