...
class Router extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    async createWebRtcTransport({ listenIps, enableUdp = true, enableTcp = false, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, appData = {} }) {
        ...
        const internal = { ...this._internal, transportId: v4_1.default() };
        const reqData = {
            listenIps,
            enableUdp,
            enableTcp,
     ...
     */
    async createPlainRtpTransport({ listenIp, rtcpMux = true, comedia = false, multiSource = false, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, appData = {} }) {
        ...
        const data = await this._channel.request('router.createPlainRtpTransport', internal, reqData);
        const transport = new PlainRtpTransport_1.PlainRtpTransport({
            internal,
            data,
            channel: this._channel,
            appData,
     ...
     */
    async createPipeTransport({ listenIp, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 1073741823, appData = {} }) {
     ...
     */
    async pipeToRouter({ producerId, dataProducerId, router, listenIp = '127.0.0.1', enableSctp = true, numSctpStreams = { OS: 1024, MIS: 1024 } }) {
    ...
    async createAudioLevelObserver({ maxEntries = 1, threshold = -80, interval = 1000, appData = {} } = {}) {
        ...
        if (appData && typeof appData !== 'object')
            throw new TypeError('if given, appData must be an object');
        const internal = { ...this._internal, rtpObserverId: v4_1.default() };
