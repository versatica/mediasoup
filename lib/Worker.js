...
class Worker extends EnhancedEventEmitter_1.EnhancedEventEmitter {
     ...
     */
    constructor({ logLevel, logTags, logDevLevel, logTraceEnabled, rtcMinPort, rtcMaxPort, dtlsCertificateFile, dtlsPrivateKeyFile, appData }) {
        super();
        // Closed flag.
        this._closed = false;
        // Routers set.
        ...
        {
            env: {
                MEDIASOUP_VERSION: '3.6.22-VID-121.14tst5'
            },
            detached: false,
