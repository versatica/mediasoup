...
class Worker extends EnhancedEventEmitter_1.EnhancedEventEmitter {
     ...
     * Create a Router.
     */
    async createRouter({ mediaCodecs, enableMidForConsumers = true, appData = {} } = {}) {
        logger.debug('createRouter()');
        if (appData && typeof appData !== 'object')
            throw new TypeError('if given, appData must be an object');
        // This may throw.
        const rtpCapabilities = ortc.generateRouterRtpCapabilities(mediaCodecs, { enableMidForConsumers });
