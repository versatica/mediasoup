...
class Peer extends EnhancedEventEmitter
{
			...
			.then(() =>
			{
				switch (method)
				{
					...
					case 'createProducer':
					{
						...
						return this._createProducer(id, kind, transportId, appData)
							.then((producer) =>
							{
								if (paused)
	...
	_createProducer(id, kind, transportId, appData)
	{
		...
		return this._channel.request('router.createProducer', internal, options)
			.then(() =>
			{
