...
#[test]
fn audio_level_observer_create() {
...
#[test]
fn audio_level_observer_pause_resume() {
    future::block_on(async move {
        let router = init().await;
...
fn audio_level_observer_drop() {
    future::block_on(async move {
        ...
        let audio_level_observer2 = router
            .create_audio_level_observer(AudioLevelObserverOptions::default())
            .await
            .expect("Failed to create AudioLevelObserver");
