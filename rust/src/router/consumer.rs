...
pub struct ConsumerOptions {
    ...
    pub pipe: bool,
    /// When set, bypasses the default ORTC-driven `rtpParameters` derivation for
    /// this Consumer and is used verbatim as the wire-level `rtpParameters`.
    /// The payload types and header-extension ids declared here become the
    /// on-wire values for this Consumer.
    ///
    ...
    /// canonical ones.
    ///
    /// Not supported together with [`ConsumerOptions::pipe`]=`true` or on a
